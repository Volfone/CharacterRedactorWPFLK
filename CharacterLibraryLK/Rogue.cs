...
namespace CharacterRedactorLK
{
    public class Rogue : Character
    {
        ...
        public Rogue(int strength, int dexterity, int constitution, int intelligence, string name, int cash, List<Item> items) :
        ...
        public Rogue(int strength, int dexterity, int constitution, int intelligence, string name, int cash, List<Item> items, int level, int exp) :
        ...
        public Rogue(int strength, int dexterity, int constitution, int intelligence, string name, int cash,
